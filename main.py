...
def attack(char_name: str, char_class: str) -> str:
    """Определяет колличество урона.
    нанесеного тем или иным классом игрока.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Определяет колличество.
    блокированого урона нанесеного игроку.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Определяет и выводит специальное умение и урон персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Предлагает игроку выбрать класс персонаж."""
    approve_choice: str = ''
    char_class: str = ''
...
if __name__ == '__main__':
    ''' Вызывает меню при старте програмы.
    '''
    run_screensaver()
